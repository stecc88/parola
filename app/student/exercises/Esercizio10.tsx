...
import { startEsercizio10, submitEsercizio10 } from './actions'
...
export function Esercizio10() {
  ...
  async function handleStart() {
    ...
    setStato('generando')
    try {
      const data = await startEsercizio10()
      setEsercizio(data)
      setRisposte({})
      setRisultato(null)
  ...
  async function handleSubmit() {
    ...
    try {
      const val = await submitEsercizio10(esercizio, arr)
      setRisultato(val)
      setStato('pronto')
    } catch (e) {
  ...
  if (stato === 'pronto' && risultato && esercizio) {
    ...
    return (
      <Card>
        ...
        <RisultatoFooter corretti={corretti} totale={totale} tipo={10} />
