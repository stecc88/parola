...
import { startEsercizio14, submitEsercizio14 } from './actions'
...
export function Esercizio14() {
  ...
  async function handleStart() {
    ...
    setStato('generando')
    try {
      const data = await startEsercizio14()
      setEsercizio(data)
      setRisposte({})
      setRisultato(null)
  ...
  async function handleSubmit() {
    ...
    try {
      const val = await submitEsercizio14(esercizio, arr)
      setRisultato(val)
      setStato('pronto')
    } catch (e) {
  ...
  if (stato === 'pronto' && risultato && esercizio) {
    ...
    return (
      <Card>
        ...
        <RisultatoFooter corretti={corretti} totale={totale} tipo={14} />
